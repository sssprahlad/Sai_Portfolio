...
const AddYourDetailsForm = ({ onClose, getMyDetails, fetchProjects, fetchMyDetails }) => {
    ...
    try {
        ...
        const response = await fetch(`${ADD_MY_DETAILS_API}${getMyDetails?.[0]?.resumeImage ? `/${getMyDetails[0].id}` : ""}`, {
                ...
                <div className="form-group">
                    ...
                    <div className="file-upload-container">
                        ...
                        <span className="file-name">
                            {resume ? resume.name : (getMyDetails?.resume ? getMyDetails.resume.split('/').pop() : getMyDetails[0]?.resumeName ? getMyDetails[0]?.resumeName : 'No file chosen')}
                        </span>
                    </div>

                  {
                    getMyDetails?.[0]?.resumeImage && <div>
                    ...
                    <div className="form-group">
                        ...
                        >
                            {yourImagePreview || getMyDetails[0]?.profileImage ? (
                                <img src={yourImagePreview || getMyDetails[0]?.profileImage} alt="Preview" className="preview-image" />
                            ) : (
                    ...
                    <div className="form-actions">
                        ...
                        <button type="submit">{getMyDetails?.[0]?.resumeImage ? "Update Details" : "Add Details"}</button>
                    </div>
                </form>
            </div>
            <SnackbarPopup
