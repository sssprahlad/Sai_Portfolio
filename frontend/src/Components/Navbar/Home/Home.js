            ...
            <div className='row-parent-container'>
                <div className='child-container1'>
                    ...
                    <div className='social-media-container'>
                       <ul>
                        <li><a className={`social-media-icon ${darkAndLightMode ? "dark-text" : "light-text"}`} href={myDetails?.instagram}><FaInstagram /></a></li>
                        <li><a className={`social-media-icon ${darkAndLightMode ? "dark-text" : "light-text"}`} href={myDetails?.github}><FaGithub /></a></li>
                        <li><a className={`social-media-icon ${darkAndLightMode ? "dark-text" : "light-text"}`} href={myDetails?.linkedIn}><FaLinkedin /></a></li>
                        <li><a className={`social-media-icon ${darkAndLightMode ? "dark-text" : "light-text"}`} href={myDetails?.twitter}><FaTwitter /></a></li>
                       </ul>
                    </div>
                    <button type="button" className='more-about-btn' onClick={() => navigate("/about")}>More About Me</button>
                </div>
                <div className='child-container2 common-container'>
                    <img className='profile-image' src={getMyDetails?.profileImage} alt="image" />
                </div>
            </div>
        </div>
    );
