          ...
          >
            <ul>
              <li onClick={handleNavClick}>
                ...
                >
                  {" "}
                  <IoHomeOutline className="nav-link-icon" /> Home{" "}
                </Link>
              </li>
              <li onClick={handleNavClick}>
                <Link
                ...
                >
                  {" "}
                  <BiErrorCircle className="nav-link-icon" /> About{" "}
                </Link>
              </li>
              <li onClick={handleNavClick}>
                <Link
                ...
                >
                  {" "}
                  <GoProjectSymlink className="nav-link-icon" /> Projects{" "}
                </Link>
              </li>
              <li onClick={handleNavClick}>
                <Link
                ...
                >
                  {" "}
                  <LuPhoneCall className="nav-link-icon" /> Contact{" "}
                </Link>
              </li>
              {token && (
                <li onClick={handleNavClick}>
                  ...
                  >
                    {" "}
                    <GrUserAdmin className="nav-link-icon" /> Admin{" "}
                  </Link>
                </li>
              )}
            </ul>
